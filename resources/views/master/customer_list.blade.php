	              	...
	              	<div class="card-header">
	                	...
	                	<div class="card-tools">
	                		<a href="/customer/trash" class="btn btn-sm btn-warning"><i class="fa fa-trash"></i> Trash</a>
			              	<a href="/customer/create" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
			            </div>
	              	</div>
	              	<div class="card-body">
	              		<div class="table-responsive">
		                	<table id="tbl-suppliers" class="table table-bordered table-striped">
		                  		<thead>
				                  	<tr>
		                  		...
		                  		<tbody>
				                  	...
				                  	<tr>
					                    ...
					                    <td class="project-actions text-center">
					                    	<a href="/customer/{{ $cust->id }}/edit" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Edit</a>
					                    	<a href="/customer/delete/{{ $cust->id }}" class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i> Hapus</a>
					                    </td>
					                    <td>{{ $cust->name }}</td>
					                    <td>{{ $cust->email }}</td>
					                    <td>{{ $cust->phone }}</td>
