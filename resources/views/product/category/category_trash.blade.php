	                  		...
	                  		<tbody>
			                  	...
			                  	<tr>
				                    ...
				                    <td class="project-actions text-center">
				                    	<a href="/category/restore/{{ $cat->catgory_id }}" class="btn btn-success btn-sm">Restore</a>
				                    	<a href="/category/forceDelete/{{ $cat->catgory_id }}" class="btn btn-danger btn-sm" onclick="return confirm('Data akan dihapus permanen. Lanjutkan?')">Hapus Permanen</a>
				                    </td>
			                  	</tr>
			                  	@endforeach
	                  		</tbody>
