	              	...
	              	<div class="card-header">
	                	...
	                	<div class="card-tools">
	                		<a href="/category/trash" class="btn btn-sm btn-warning"><i class="fa fa-trash"></i> Trash</a>
			              	<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#category-add"><i class="fas fa-plus"></i> Tambah Data</button>
			            </div>
	              	</div>
...
<script>
    ...
    // FORM EDIT
    function show(id) {
        $.get("{{ url('/category/show') }}/" + id, {}, function(data, status) {
        	$('#id').val(data.id);
            $('#code_edit').val(data.category_code);
    ...
    function destroy(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("{{ url('/category/destroy') }}", {id, _token}, function(data) {
                    if(data.status == 'success') {
