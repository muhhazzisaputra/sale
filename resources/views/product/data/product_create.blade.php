        ...
        <form id="form_input" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="custom-control custom-checkbox col-sm-12">
                                        <input name="gambar_default" id="gambar_default" class="custom-control-input" type="checkbox" onclick="set_img_default()">
                                        <label for="gambar_default" class="custom-control-label" style="font-weight: 400 !important;">Gunakan gambar default</label>
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="group_code" id="group_code">
                                        ...
                                        @foreach($groups as $group)
                                            <option value="{{ $group->group_code }}">{{ $group->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="weight" class="form-control" id="weight" style="text-align: right;" onkeyup="num_only(this)">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <img src="{{ asset('storage/product-images-default.png') }}" id="preview_img_set" alt="Gambar Utama Produk" class="img-thumbnail" onclick="preview_img(this)" style="height: 115px; width: 120px;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="product_sku" class="col-sm-4 col-form-label">SKU Produk</label>
                                <div class="col-sm-8">
                                    <input type="text" name="product_sku" class="form-control" id="product_sku" style="width: 140px;">
                                    <div class="custom-control custom-checkbox col-sm-12">
                                        <input name="sku_default" id="sku_default" class="custom-control-input" type="checkbox" onclick="set_sku_default()">
                                        <label for="sku_default" class="custom-control-label" style="font-weight: 400 !important;">Gunakan kode yang disarankan sistem</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="min_stock" class="form-control" id="min_stock" style="text-align: right;" onkeyup="num_only(this)">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4" style="margin-top: 8px;">
                                    <div class="form-group row">
                                        <div class="custom-control custom-radio col-sm-6">
                                            <input class="custom-control-input" type="radio" id="ya" name="variant" value="ya" onclick="set_variant_status()">
                                            <label for="ya" class="custom-control-label">Ya</label>
                                        </div>
                                        <div class="custom-control custom-radio col-sm-6">
                                            <input class="custom-control-input" type="radio" id="tidak" name="variant" value="tidak" onclick="set_variant_status()" checked>
                                            <label for="tidak" class="custom-control-label">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row" id="variant_section" hidden>
                                ...
                                <div class="col-sm-6" style="margin-top: 8px;">
                                    <div class="form-group row">
                                        <div class="custom-control custom-checkbox col-sm-4">
                                            <input class="custom-control-input" type="checkbox" name="warna" id="warna">
                                            <label for="warna" class="custom-control-label">Warna</label>
                                        </div>
                                        <div class="custom-control custom-checkbox col-sm-6">
                                            <input class="custom-control-input" type="checkbox" name="ukuran" id="ukuran">
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-primary" id="btn_save" onclick="save_product()">Simpan</button>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    function set_sku_default() {
        if($('#sku_default').is(':checked')) {
            let category_code = $('#category_code').val();
            if(category_code == "") {
                alert('Pilih kategori produk terlebih dahulu');
                $('#sku_default').prop('checked', false);
                $('#category_code').focus();
                return false;
            }
            ...
            $.post('{{ url('/product/set_sku_default') }}', {_token, category_code, group_code}, function(result) {
                $('#product_sku').val(result);
                $('#product_sku').prop('readonly', true);
            });
        } else {
            $('#product_sku').prop('checked', false);
    ...
    function save_product() {
        let prim_image = $('#prim_image').val();
        if(prim_image == "") {
            alert('Gambar utama produk wajib diisi');
            return false;
        }
        ...
        let form_data = new FormData($('#form_input')[0]);
