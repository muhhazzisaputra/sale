...
<div class="modal-body">
    <form id="form_variant_all_add" autocomplete="off">
        @csrf
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="save_variant_all()">Simpan</button>
...
<script>
    ...
    function save_variant_all() {
        ...
        $.post("{{ url('/product/save_variants') }}", $("#form_variant_all_add").serialize(), function(data) {
