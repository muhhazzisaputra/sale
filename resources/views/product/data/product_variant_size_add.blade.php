...
<div class="modal-body">
    <form id="form_variant_size_add" autocomplete="off">
        @csrf
        <input type="hidden" name="type" value="size">
        <div class="form-group row">
            <label for="" class="col-sm-4 col-form-label">Ukuran Produk<span style="color: red;">*</span></label>
            <div class="col-sm-4">
                <select class="form-control" name="size_code" id="size_code">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="save_variant_size()">Simpan</button>
...
<script>
    ...
    // STORE PROCESS
    function save_variant_size() {
        let size_code = $("#size_code").val();
        if(size_code == "") {
        ...
        $.post("{{ url('/product/save_variants') }}", $("#form_variant_size_add").serialize(), function(data) {
