        ...
        <div class="row mb-2">
          	...
          	<div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              	...
	              	<li class="breadcrumb-item"><a href="/group">Kelompok Produk</a></li>
	                  		...
	                  		<tbody>
			                  	...
			                  	<tr>
				                    ...
				                    <td class="project-actions text-center">
				                    	<a href="/group/restore/{{ $group->id }}" class="btn btn-success btn-sm">Restore</a>
				                    	<a href="/group/forceDelete/{{ $group->id }}" class="btn btn-danger btn-sm" onclick="return confirm('Data akan dihapus permanen. Lanjutkan?')">Hapus Permanen</a>
				                    </td>
				                    <td>{{ $group->code }}</td>
				                    <td>{{ $group->name }}</td>
			                  	</tr>
