                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="purchase_date" class="form-control today" id="purchase_date" value="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="purchase_date" class="col-sm-6 col-form-label">Tanggal Jatuh Tempo<span style="color: red;">*</span></label>
                                <div class="col-sm-4">
                                    <input type="text" name="purchase_duedate" class="form-control today" id="purchase_duedate" value="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive mt-2">
                                ...
                                <div style="text-align: right;">
                                    <a href="/purchase" class="btn btn-md btn-danger">Batal</a>
                                    <button class="btn btn-md btn-primary" type="button" id="save_btn" onclick="purchase_save(this)">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function add_row(urut='') {
        ...
        new_row = `<tr>
                        ...
                        <td>
                            <select class="form-control" name="product_code_alias[]" id="product_code_alias_${no_akhir_set}" onchange="double_product_check(${no_akhir_set})" style="width: 430px;">
                                <option value="">-PILIH-</option>
